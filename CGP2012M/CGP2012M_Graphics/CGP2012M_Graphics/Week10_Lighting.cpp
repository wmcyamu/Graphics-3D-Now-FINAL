...
int main(int argc, char *argv[]) {
	...
	modelLoader.LoadOBJ2("..//..//Assets//Models//torus2.obj", model.vertices, model.texCoords, model.normals, model.indices);
	...
	glm::vec3 lightPosition = glm::vec3(0.5f, 0.0f, 0.5f);
	...
	while (windowOpen)
	{
		...
		//lighting uniforms
		//get and set light colour uniform
		lightColLocation = glGetUniformLocation(cube.shaderProgram, "lightCol");
		glUniform3fv(lightColLocation, 1, &lightColour[0]);
		//rotation
		...
		//glUniformMatrix4fv(importModelLocation, 1, GL_FALSE, glm::value_ptr(modelTranslate*modelRotate));
